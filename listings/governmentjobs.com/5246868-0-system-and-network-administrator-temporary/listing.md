# [System and Network Administrator (Temporary)](https://www.governmentjobs.com/jobs/5246868-0/system-and-network-administrator-temporary)
...
is accepting applications to fill a
System and Network Administrator (Temporary)
position in our
Regional Fire Communication Center
...
This is a unique and exciting opportunity to be a part of a new regional fire-rescue-EMS communications/dispatch program.
...
The System and Network Administrator job classification title is EDP (Electronic Data Processing) Systems and Programming Analyst I.
EDP Systems & Programming Analyst I: $47.15 - $56.76  Hourly
EDP Systems & Programming Analyst II: $51.72 - $62.34  Hourly
Note
: EDP Systems and Programming Analyst I/II is a flexibly staffed class series. Employees may be hired at either the I or II level of the series. The I level is the entry level of the systems and programming analyst series, occupied by employees who require close supervision while acquiring great technical knowledge and ability to work with clients in needs and feasibility applications analysis. Employees at the II level work from general instruction and consult supervisors for guidance on policy matters and assist in the resolution of difficult technical problems.
...
The
IDEAL CANDIDATE will have system administrator knowledge and experience in:
Operating systems such as Windows Server, Active Directory, data collection and analysis methods.
Configuring, monitoring and troubleshooting firewalls and system security.
...
Provide excellent and courteous customer service, and establish and maintain cooperative work relationships with customers and colleagues.
The successful applicant is expected to possess some, but not all of the following:
Working across various platforms such as databases, cloud applications, and system integrations.
...
Completion of 24 quarter/18 semester units of college-level courses in the principles and methods of systems analysis, systems design, computer program design, computer programming using a language utilized by the hiring department, and information system technology,

### And

two years of experience writing business application programs;
...
basic principles of electronic records management to design or modify programs, bookkeeping to design or modify programs, and budgeting to design or modify programs; principles of project management; basic principles of supervision; and principles of database design.
...
Review applications and supplemental questionnaires
to determine those candidates who meet the employment standards. Candidates that meet the employment standard will have their applications sent to the hiring department for review.

### Conditional Job Offer

Once a conditional offer of employment has been made, candidate will be required to successfully complete a background check, which includes a conviction history check, and satisfactory reference checks. Appointee will be subject to a post-offer medical evaluation or examination.
Recruiters will correspond with applicants by email
...
steps listed above to ensure they do not miss required deadlines. The County of Santa Barbara will not release any applicant's email address to a third party.
...
The County of Santa Barbara provides equal employment opportunities to all employees and applicants and prohibits discrimination, harassment, and retaliation of any type with regard to any characteristic or status protected by any federal law, state law, or Santa Barbara County ordinance. The County continues to be committed to a merit-based selection process and to eliminating barriers to attracting and retaining top qualified
candidates. The County has a long-standing practice of providing a work environment that respects the dignity of individual employees and values their contributions to our organization.
...
.
If you have any questions regarding this recruitment, please contact Alexandria White, Santa Barbara County Fire Department Talent Acquisition Analyst,
amwhite@countyofsb.org
.
